    ...
    return (
        <div className="min-h-screen bg-slate-50 flex flex-col">
            ...
            <main className="flex-1 flex items-center justify-center px-4 py-8">
                <div className="w-full max-w-[440px] bg-white rounded-2xl border border-slate-200 p-8 md:p-10">
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-5">
                        ...
                        >
                            {loading || form.formState.isSubmitting ? "Logging In..." : "Log In"}
                        </button>
                        ...
                        <div className="text-center mt-4">
                            <p className="text-slate-500 text-sm">
                                ...
                                <Link className="text-blue-600 font-medium hover:text-blue-700 ml-1" href="/auth/signup">Sign Up</Link>
                            </p>
                        </div>
                    </form>
