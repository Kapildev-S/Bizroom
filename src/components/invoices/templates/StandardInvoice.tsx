            ...
            <table className="w-full border-collapse">
                <thead>
                    <tr>
                        ...
                        <th className="border border-black p-1 text-center font-bold w-16">Qty</th>
                        <th className="border border-black p-1 text-center font-bold w-24">Rate</th>
                ...
                <div className="w-1/2">
                    <div className="grid grid-cols-[1fr,auto]">
                        ...
                        {invoice.discountAmount && invoice.discountAmount > 0 && (
                            <React.Fragment>
                                <p className="p-1 border-b border-black">Discount</p>
                                <p className="p-1 border-b border-black text-right">-{currencySymbol}{(invoice.discountAmount || 0).toFixed(2)}</p>
                            </React.Fragment>
                        )}
                        <p className="p-1 border-b border-black">Tax ({(invoice.taxRate * 100).toFixed(2)}%)</p><p className="p-1 border-b border-black text-right">{currencySymbol}{invoice.taxAmount.toFixed(2)}</p>
